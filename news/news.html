        ...
        <ul class="c-news__list">
          <li class="c-news__item">
            <a href="/news/news-single.html" class="c-news__link animsition-link">
              <span class="c-news__date c-txt-sm">2021.4.5</span>
              <p class="c-news__tit c-txt-sm">新型コロナウィルス感染予防について。</p>
            </a>
          </li>
          <li class="c-news__item">
            <a href="/news/news-single.html" class="c-news__link animsition-link">
              <span class="c-news__date c-txt-sm">2021.1.5</span>
              <p class="c-news__tit c-txt-sm">東京都緊急事態宣言について。</p>
            </a>
          </li>
          <li class="c-news__item">
            <a href="/news/news-single.html" class="c-news__link animsition-link">
              <span class="c-news__date c-txt-sm">2020.11.5</span>
              <p class="c-news__tit c-txt-sm">ホームページリニューアルしました</p>
            </a>
          </li>
        </ul>
