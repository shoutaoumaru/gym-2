              ...
              <ul>
                <li>
                  <h4 class="points-title">
                    ...
                    <span class="c-txt-lr">チャレンジ精神旺盛で、<br>やり切る力を持った人材</span>
                  </h4>
                  <div class="points-desc">
                    <p class="c-txt-sm">
                      新たな業界のスタンダードとなるジムを目指し、高い目標意識を持って日々研鑽しています。強い意思と行動力を持ち、「一生に一度しかない人生で、“大きな事にチャレンジ”したい」という意欲あふれる人材を求めています。
                    </p>
                  </div>
                </li>
                <li>
                  <h4 class="points-title">
                    ...
                    <span class="c-txt-lr">真摯な姿勢で自分を<br>高めていける人材</span>
                  </h4>
                  <div class="points-desc">
                    <p class="c-txt-sm">
                      RivRoundで取り入れている「360度評価」は、1ヶ月を1クールとして、良かった点と直すべき点が３軸の視点から可視化されます。他者を通して自分を俯瞰すると、自分でも思っていなかった弱みや強みが見つかります。その評価を受けて、強みは自覚的に高め、弱みがあれば改善していくことが、その後の成長に大きく作用することでしょう。
                    </p>
                  </div>
                </li>
                <li>
                  <h4 class="points-title">
                    ...
                    <span class="c-txt-lr">個もチームも大切<br>に出来る人材</span>
                  </h4>
                  <div class="points-desc">
                    <p class="c-txt-sm">
                      一般的にほとんどのジムが非正規雇用やアルバイトなどの雇用形態を用意している中、RivRoundではあえて“正社員雇用のみ”にこだわりを持っています。それは、RivRoundがセッションや食事指導といった個人プレーに留まらず、「お客様の一生をサポートするプロフェッショナル集団」という大きなmissionに向かって、共に切磋琢磨出来る仲間を求めています。
                    </p>
                  </div>
                </li>
              </ul>
